...
public class T06TreeSetTest {
	public static void main(String[] args) {
		...
		Collections.shuffle(abcList); // 섞기
		...
		//TreeSet에 저장된 자료 중 특정한 자료보다 작은 자료를 찾아서 SortedSet으로 반환하는 메소드가 있다.
		//headSet(기준값) : 기본적으로 '기준값' 미포함
		//headSet(기준값, 논리값) : 논리값이 true면 '기준값' vhgka.
		...
		//subSet(기준값1, 논리값1, 기준값2, 논리값2) : 기준값1 ~ 기준값2 사이의 값을 가져옴. (논리값이 true면 기준값 포함)
